...
const AppHeader: React.FC = () => {
    ...
    return (
        <header
            className="sticky top-0 flex w-full bg-white border-gray-200 z-50 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
                    ...
                    <Link to="/" className="lg:hidden">
                        <div className="flex items-center space-x-3">
                            ...
                            <div className="flex flex-col leading-tight">
                                <h1 className="text-xl font-bold text-black dark:text-white">AURI</h1>
                                <p className="text-xs text-black/80 dark:text-white/80">Admin Dashboard</p>
                            </div>
                        </div>
                    </Link>
