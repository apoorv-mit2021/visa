...
import { getLowStockProducts, type LowStockItem } from "../../../services/dashboardService";
...
export default function LowStockProducts() {
    ...
    const getStatus = (qty: number): { label: "Critical" | "Low" | "Moderate"; color: "error" | "warning" | "info" } => {
        if (qty <= 2) return { label: "Critical", color: "error" };
        if (qty <= 5) return { label: "Low", color: "warning" };
                            ...
                            [...Array(5)].map((_, i) => (
                                <TableRow key={i}>
                                    <TableCell className="py-3">
                                        <div className="flex items-center gap-3">
                                            <div className="h-[50px] w-[50px] overflow-hidden rounded-md bg-gray-100 dark:bg-gray-800 animate-pulse" />
                                            <div>
