...
import { getDashboardMetrics, type DashboardMetrics as DashboardMetricsType } from "../../../services/dashboardService";
...
export default function EcommerceMetrics() {
  ...
  useEffect(() => {
    ...
    const fetchMetrics = async () => {
      try {
        ...
        setMetrics({ total_customers: 0, total_orders: 0 });
      } finally {
        setLoading(false);
      }
    };
  ...
  const customers = metrics?.total_customers ?? 0;
