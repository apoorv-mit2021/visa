...
export default function InventoryMetrics({refreshKey = 0}: { refreshKey?: number }) {
    ...
    useEffect(() => {
        const fetchMetrics = async () => {
            try {
                setLoading(true);
                const data = await getInventoryMetrics(token);
                setMetrics(data);
            } catch (error: unknown) {
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                ...
                <div className="flex items-end justify-between mt-5">
                    <div>
                        ...
                        <h4 className="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{metrics.total_products}</h4>
                    </div>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                ...
                <div className="flex items-end justify-between mt-5">
                    <div>
                        ...
                        <h4 className="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{metrics.total_stock}</h4>
                    </div>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                ...
                <div className="flex items-end justify-between mt-5">
                    <div>
                        ...
                        <h4 className="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{metrics.low_stock_items}</h4>
                    </div>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                ...
                <div className="flex items-end justify-between mt-5">
                    <div>
                        ...
                        <h4 className="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{metrics.out_of_stock_items}</h4>
                    </div>
                    <Badge color="error">Zero</Badge>
                </div>
            </div>
        </div>
    );
